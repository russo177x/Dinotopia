...
public class GameManager : MonoBehaviour {
	...
	void OnGUI() {
		GUI.Label (new Rect (7, 17, 110, 110), "<b>TEMPO: </b>" + score, GameScoreGUI);
		GUI.Label (new Rect (7, 17, 110, 110), "<b>DINOS RESTANDO: </b>" + numberofshapes, ShapesLeftGUI);
		if (showGUI) {
			...
			GUI.Label (new Rect(Screen.width / 2 - 48f, ((Screen.height / 2) - 34.5f), 40, -210), "TERMINADO EM: " + score + " seg", EndGameScoreGUI);
			GUI.Label (new Rect(Screen.width / 2 - 48f, ((Screen.height / 2) - 34.5f), 40, -210), "BOM TRABALHO, VOCÊ É DEMAIS!", EndGameGUI);
